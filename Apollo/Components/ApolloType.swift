...
extension ApolloTextRole {
    ...
    fileprivate var spec: Spec {
        ...
        case .nameSmall:    return Spec(family: .serif, size: 12, weight: .regular, serifName: ApolloFontName.serifSemiBold,       tracking:  0.00, lineHeightMultiple: 1.20, uppercase: false, relativeTo: .caption1)
        case .nameSmallYou: return Spec(family: .serif, size: 12, weight: .regular, serifName: ApolloFontName.serifSemiBoldItalic, tracking:  0.00, lineHeightMultiple: 1.20, uppercase: false, relativeTo: .caption1)
        ...
        case .caption:      return Spec(family: .sans,  size: 12, weight: .regular, serifName: "",                                 tracking: -0.24, lineHeightMultiple: 1.30, uppercase: false, relativeTo: .caption1)
